...
import uo.mp.battleship.squares.Ship;
import uo.mp.battleship.squares.Water;
...
public class BoardBuilder {
	 ...
	 * en coordenadas aleatorias o fijas (según la opción elegida por el alumno) y
	 * que se describe en la siguiente sección. -Rellenar el resto del tablero con
	 * instancias de la clase Water. -size debería estar ahora en el rango [10,15].
