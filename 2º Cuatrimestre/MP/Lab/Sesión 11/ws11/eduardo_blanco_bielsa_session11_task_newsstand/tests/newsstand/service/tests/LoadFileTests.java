...
public class LoadFileTests {
	 ...
	 * Casos:
	 * 
	 * 1 Nombre del fichero es nulo -> salta excepción
	 * 2 Nombre del fichero vacío -> salta excepción
	 * 3 Longitud del nombre inválida -> se recoge la excepción
	 * 4 Archivo no encontrado -> se recoge la excepción
	 */
	...
	/**
	 * GIVEN un objeto NewsStand
	 * WHEN nombre del fichero es vacío
	 * THEN salta excepción
	 */
	@Test
	(expected = IllegalArgumentException.class)
	...
	/**
	 * GIVEN un objeto NewsStand
	 * WHEN Longitud del nombre inválida
	 * THEN se recoge la excepción
	 */
	@Test
