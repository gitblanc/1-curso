...
public class Newsstand {
	 ...
	 */
	public void loadFile(String inFileName) throws NewsStandException, InvalidFileNameException {
		ArgumentsCheck.isNotEmpty(inFileName);
	...
	public void removePublication(String name) throws NewsStandException {
		if (searchByName(name)!=-1) {
			publications.remove(searchByName(name));
		} else {
			throw new NewsStandException("No se encuentra el indicado");
		}
	}
	 ...
	 * @throws InvalidFileNameException 
	 */
	public void importPublicationsFromZipFile(String fileName) throws FileNotFoundException, InvalidFileNameException {
		ArgumentsCheck.isNotEmpty(fileName);
